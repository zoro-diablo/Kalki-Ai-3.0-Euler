    ...
    >
      ...
      <div>
        ...
        <motion.div
          ...
          whileHover={{ rotate: 5 }}
        >
          <img src='/bull.png' alt='package' className='w-[150px] my-10' />
        </motion.div>
        <motion.div
        ...
        >
          <div className='flex justify-center mt-5 gap-x-3'>
            <ul className='list-disc list-inside text-white'>
              <li className='mb-3'><span className='font-semibold text-sky-500'>We Charge: </span><span className='text-sky-200'>$10,000</span></li>
              <li className='mb-3'><span className='font-semibold text-sky-500'>High Returns: </span><span className='text-sky-200'>56.44%</span></li>
              <li className='mb-3'><span className='font-semibold text-sky-500'>Risk: </span><span className='text-sky-200'>High Risk</span></li>
              <li className='mb-3'><span className='font-semibold text-sky-500'>Ai Assistant: </span><span className='text-sky-200'>Euler</span></li>
            </ul>
          </div>
        </motion.div>

        <h3 className='text-base font-semibold text-orange-500 flex justify-center'>
          Risky
        </h3>
        <span className='text-md mt-4 font-medium text-white flex text-center'>
          Experience traditional trading without AI, leading to high risk and modest returns.
        </span>
